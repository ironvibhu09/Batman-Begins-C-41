...
function preload(){
  ...
  // load both thunder images
    thunder1 = loadImage("Image/Thunderno1.png");
    thunder2 = loadImage("Image/Thunderno2.png");
    Thunder = loadImage("Image/images.jpg")
}
...
thunderImg1 = createSprite(displayWidth/2,10,10,40);
...
// display umbrella img
    img.display();
// display raindrops
    for(var i = 10; i < raindrops.length; i++){
      raindrops[i].fall(20);
      raindrops[i].display();
    } 
